...
# All state data built directly into Python (proper True/False)
state_data = {
  "Alabama": {
...
fig.update_layout(height=400, margin={"r":0,"t":40,"l":0,"b":0}, coloraxis_showscale=False)
